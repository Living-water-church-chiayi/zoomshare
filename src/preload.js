...
contextBridge.exposeInMainWorld('api', {
  ...
  nativeAudioCommand: (command) => ipcRenderer.invoke('native-audio:command', command),
  ...
  startWindowDrag: (point) => ipcRenderer.send('win:drag-start', point),
  moveWindowDrag: (point) => ipcRenderer.send('win:drag-move', point),
  endWindowDrag: () => ipcRenderer.send('win:drag-end'),
